			...
			<SheetPortal>
				...
				<SheetPrimitive.Content
					...
					className={cn(
						...
						side === "left" &&
								"data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left top-2 bottom-2 left-2 h-auto w-full max-w-[calc(100vw-1rem)] rounded-sm border sm:w-3/4 sm:max-w-sm",
