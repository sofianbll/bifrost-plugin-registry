...
Clarification suivante de Sofian : retirer les packs clients composés localement et centrer le laboratoire sur le harness fourni par Bifrost. Réduire la surcharge avec un choix « Tous les tests / Personnaliser », une préparation progressive et des détails avancés repliés. Le choix « Tous » du prototype porte explicitement sur ses scénarios illustratifs ; l'import de la collection officielle et son exécution restent à réaliser. Aucun second type de harness n'est ajouté au parcours à cette étape.
