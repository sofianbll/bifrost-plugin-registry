...
| Frontend dependencies | Resolved by [ui/package-lock.json](ui/package-lock.json) | Release notices copy available license texts and explicitly identify declared MIT packages shipped without a license file, with shared MIT terms |
